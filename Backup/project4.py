...
class Maison():
    ...
    def rotate(self):
        ...
        self.rect_vr.w = self.w_vr
        self.rect_vr.h = self.h_vr
        self.rect_extra.w = self.w_vr+10
        self.rect_extra.h = self.w_vr+10
...
def positionHelper(a, b, afstanden, position):
